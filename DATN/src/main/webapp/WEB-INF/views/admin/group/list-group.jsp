        ...
        <body class="no-skin">
            ...
            <div class="main-container" id="main-container">
                ...
                <div class="main-content">
                    <form action="<c:url value='/admin-group'/>" id="formSubmit" method="GET">
                                            ...
                                            <div class="table-btn-controls">
                                                <div class="pull-right tableTools-container">
                                                    <div class="dt-buttons btn-overlap btn-group">
														...
														<c:url value="/admin-addOrUpdateGroup" />' <c:if
                                                            test="${userFunction.contains('add-group') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userFunction.contains('add-group') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                                            > <span>
                                                        ...
                                                        <button id="btnDelete" type="button" <c:if
                                                            test="${userFunction.contains('delete-group') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userFunction.contains('delete-group') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="item" items="${listGroup}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <c:forEach var="groupFunction"
                                                                            items="${groupFunctions[loop.index]}">
                                                                            <span>${groupFunction}</span><br>
                                                                        </c:forEach>
                                                                        <!-- ${listRoleDetail[loop.index]} -->
                                                                    </td>
                                                                    <td>
                                                                        <c:url var="editURL"
                                                                            value="/admin-addOrUpdateGroup">

                                                                            <c:param name="id" value="${item.id}" />
                                                                        </c:url> <a
                                                                            class="btn btn-sm btn-primary btn-edit"
                                                                            <c:if
                                                                            test="${userFunction.contains('edit-group') == true}">
                                                                            style="visibility:
                                                                            visible;"</c:if>
                                                                            <c:if
                                                                                test="${userFunction.contains('edit-group') == false}">
                                                                                style="visibility:
                                                                                hidden;"</c:if>
            ...
            function deleteGroup(data) {
                $.ajax({
                    ...
                    success: function (result) {
                        window.location.href = "/admin-group?&message=delete_success";
                    },
