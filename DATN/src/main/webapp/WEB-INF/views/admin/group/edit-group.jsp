<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                    ...
                    <ul class="nav nav-list">
                        <li><a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-list"></i> <span
                            ...
                            <ul class="submenu">
                                ...
                                <li><a
                                        href='<c:url value ="/admin-group"/>'>
                                        <i class="menu-icon fa fa-caret-right"></i> DS nhóm quyền
                                    </a> <b class="arrow"></b></li>
                        
                                <li><a
                                        href='<c:url value ="/admin-function"/>'>
                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Chỉnh sửa nhóm quyền</li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <form id="formSubmit">
                                        ...
                                        <br />
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right">Chi tiết
                                                quyền</label>
                                            <div class="col-sm-9">
                                                <c:forEach var="item" items="${functionName}">
                                                    <input id="${item}" type="checkbox" name="listStringFunctionName"
                                                        value="${item}" <c:forEach var="item1"
                                                        items="${groupFunctions}">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <c:if test="${not empty groups.id}">
                                                    <input type="button" class="btn btn-white btn-warning btn-bold"
                                                        value="Cập nhật nhóm quyền" id="btnAddOrUpdateGroup" />
                                                </c:if>
                                                <c:if test="${empty groups.id}">
                                                    <input type="button" class="btn btn-white btn-warning btn-bold"
                                                        value="Thêm nhóm quyền" id="btnAddOrUpdateGroup" />
                                                </c:if>
                                            </div>
                                        </div>
                                        <input type="hidden" value="${groups.id}" id="id" name="id" />
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            $('#btnAddOrUpdateGroup').click(function (e) {
                e.preventDefault();
                // var data = {};
            ...
            function addGroup(data) {
                ...
                data.forEach(element => {
                    ...
                    if (element.name == "code")
                        code = element.value;
                    if (element.name == "listStringFunctionName")
                        grFunction.push(element.value);
                    if (element.name == "id")
                        id = element.value;
                });
                sendDta = {
                    name: name,
                    code: code,
                    listStringFunctionName: grFunction,
                    id: id
                };
                $.ajax({
                    url: '/api-admin-group',
                    ...
                    success: function (result) {
                        window.location.href = "/admin-addOrUpdateGroup?id=" + result.id + "&message=insert_success";
                    },
            ...
            function updateGroup(data) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (result) {
                        window.location.href = "/admin-addOrUpdateGroup?id=" + result.id + "&message=update_success";
                    },
                    error: function (error) {
                        window.location.href = "/admin-group?message=error_system";
                    }
