                ...
                <div id="sidebar" class="sidebar responsive ace-save-state">
                    ...
                    <ul class="nav nav-list">
                        <li><a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-list"></i> <span
                                ...
                                Quản lí nhóm quyền <b class="arrow fa fa-angle-down"></b>
                            </a> <b class="arrow"></b>
                            <ul class="submenu">
                                <li><a
                                            ...
                                            <div class="table-btn-controls">
                                                <div class="pull-right tableTools-container">
                                                    <div class="dt-buttons btn-overlap btn-group">
														...
														<c:url value="/admin-addOrUpdateGroupRole" />' <c:if
                                                            test="${userRoleDetail.contains('add-grouprole') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userRoleDetail.contains('add-grouprole') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                                            > <span>
                                                        ...
                                                        <button id="btnDelete" type="button" <c:if
                                                            test="${userRoleDetail.contains('delete-grouprole') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userRoleDetail.contains('delete-grouprole') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="item" items="${listGroupRole}"
                                                                varStatus="loop">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <c:forEach var="groupRoleRoleDetail"
                                                                            items="${groupRoleRoleDetails[loop.index]}">
                                                                            <span>${groupRoleRoleDetail}</span><br>
                                                                        </c:forEach>
                                                                        <!-- ${listRoleDetail[loop.index]} -->
                                                                    </td>
                                                                    <td>
                                                                        <c:url var="editURL"
                                                                            value="/admin-addOrUpdateGroupRole">

                                                                            <c:param name="id" value="${item.id}" />
                                                                        </c:url> <a
                                                                            class="btn btn-sm btn-primary btn-edit"
                                                                            <c:if
                                                                            test="${userRoleDetail.contains('edit-grouprole') == true}">
                                                                            style="visibility:
                                                                            visible;"</c:if>
                                                                            <c:if
                                                                                test="${userRoleDetail.contains('edit-grouprole') == false}">
                                                                                style="visibility:
                                                                                hidden;"</c:if>
            ...
            function deleteGroupRole(data) {
                $.ajax({
                    ...
                    success: function (result) {
                        window.location.href = "/admin-grouprole?&message=delete_success";
                    },
