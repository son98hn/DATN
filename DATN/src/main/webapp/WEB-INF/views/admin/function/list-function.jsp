    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body class="no-skin">
            ...
            <div class="main-container" id="main-container">
                ...
                <div class="main-content">
                    <form action="<c:url value='/admin-function'/>" id="formSubmit" method="GET">
                                            ...
                                            <div class="table-btn-controls">
                                                <div class="pull-right tableTools-container">
                                                    <div class="dt-buttons btn-overlap btn-group">
														...
														<c:url value="/admin-addOrUpdateFunction" />' <c:if
                                                            test="${userFunction.contains('add-function') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userFunction.contains('add-function') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                                            > <span>
                                                        ...
                                                        <button id="btnDelete" type="button" <c:if
                                                            test="${userFunction.contains('delete-function') == true}">
                                                            style="visibility:
                                                            visible;"</c:if>
                                                            <c:if
                                                                test="${userFunction.contains('delete-function') == false}">
                                                                style="visibility:
                                                                hidden;"</c:if>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="item" items="${listFunction}"
                                                                varStatus="loop">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <c:url var="editURL"
                                                                            value="/admin-addOrUpdateFunction">

                                                                            <c:param name="id" value="${item.id}" />
                                                                        </c:url> <a
                                                                            class="btn btn-sm btn-primary btn-edit"
                                                                            <c:if
                                                                            test="${userFunction.contains('edit-function') == true}">
                                                                            style="visibility:
                                                                            visible;"</c:if>
                                                                            <c:if
                                                                                test="${userFunction.contains('edit-function') == false}">
                                                                                style="visibility:
                                                                                hidden;"</c:if>
        ...
        <script>
            ...
            function deleteFunction(data) {
                $.ajax({
                    url: '/api-admin-function',
                    type: 'DELETE',
                    contentType: 'application/json',
                    data: JSON.stringify(data),
                    dataType: 'json',
                    success: function (result) {
                        window.location.href = "/admin-function?&message=delete_success";
                    },
                    error: function (error) {
                        window.location.href = "/admin-function?&message=error_system";
                    }
                });
            }
        </script>
